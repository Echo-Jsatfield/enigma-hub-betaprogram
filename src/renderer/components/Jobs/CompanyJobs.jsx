// src/components/Jobs/CompanyJobs.jsx
...
export default function CompanyJobs() {
  ...
  const exportToCSV = () => {
    ...
    a.href = url;
    a.download = `company_jobs_export_${new Date().toISOString().split("T")[0]}.csv`;
    a.click();
  };
                ...
                {jobs.map((job) => (
                  ...
                  >
                    <td className="px-6 py-3 whitespace-nowrap">
                      <span className="font-mono text-xs" style={{ color: "#f8cc00" }}>
